...
const Service = (props) => {
  ...
  return (
    <div style={props.service.id % 2 ? { flexDirection: 'row' } : { flexDirection: 'row-reverse' }} className='service' ref={serviceRef}>
      <div className='service-img-div'>
        <img className='service-img' src={props.service.img} alt='img' ref={imgRef} />
      </div>
